 ...
 */
class DartCallHandler(
    delegate: DartToNative,
) : MethodChannel.MethodCallHandler, EventChannel.StreamHandler, DartToNative by delegate {
            ...
            when (call.method) {
                ...
                "openAsset" -> {
                    val pdFileAssetPath = call.arguments as? String
                        ?: throw PdException(
                            "argument is missing",
                            "openAsset() require an argument String"
                        )
